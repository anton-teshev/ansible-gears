...
#    end
  ...
  config.vm.define "node3" do |node3|
    ...
    node3.vm.network "private_network", ip: "192.168.56.113"
    node3.vm.provision "shell", inline: $hostsfile_update
#    config.vm.provider "virtualbox" do |vb|
#      vb.customize ["modifyvm", :id, "--audio", "none"]
#    end
  end
